...
class getCreateBooking extends Execute
{
    ...
    public function _doGetCreateBooking()
	{
		$_Bstatus  = true;
		$_Smessage = '';
		$_Adata	   = array();
    ...
    // echo "<pre>";print_r($_AflightResult);die;
		...
		$_AlowFareSearchResp = $this->xmlstrToArray($_AflightResult);
		$_AflightResult = $_AlowFareSearchResp['Body']['OrderViewRS'];
		
    echo "<pre>";print_r($_AlowFareSearchResp);
		...
		if(isset($this->_Ainput['printApiResponse']) && $this->_Ainput['printApiResponse'] == "Y"){
			...
			if(isset($_AflightResult['Errors']) && !empty($_AflightResult['Errors'])){
				...
				// }
        echo "<pre>";
        print_r($_AflightResult['Errors']);
        exit;
			}
		
		$_AflightSchedules  = array();
    // echo "<pre>";
    // print_r($_AflightResult);
    // exit;
		if(isset($_AflightResult['Response']) && $_AflightResult['Response']){
     
      $_AbaggageAllowanceList	 = $_AflightResult['Response']['DataLists']['BaggageAllowanceList'];
	  
      $_ContactInfoList	 = $_AflightResult['Response']['DataLists']['ContactInfoList']['ContactInfo'];
      $_PaxJourneyList	 = $_AflightResult['Response']['DataLists']['PaxJourneyList'];
      $_PaxList	 = $_AflightResult['Response']['DataLists']['PaxList']['Pax'];
      $_PaxSegmentList	 = $_AflightResult['Response']['DataLists']['PaxSegmentList']['PaxSegment'];
      $_Order	 = $_AflightResult['Response']['Order'];
      // $_PaxList	 = $_AflightResult['Response']['DataLists']['PaxList'];
    //  echo count($_PaxSegmentList);exit;
      $_Input =$this->_Ainput['paxDetails'];
      ...
      $keys = array_keys($_Asector_info);
     $lastKey = $keys[count($keys)-1];
      // exit;
      $_result['pnr']=$_Order['OrderID'];
      $_result['ReservationBalance']='';
      $_result['lastTicketingDate']='';
      $_result['status']='1';
      $_result['bookingStatus']= 'Confirmed';//$_Order['OrderItem']['StatusCode'];
      $_result['flightDetails']['departureStation']=$_Asector_info[0]['Dep']['IATA_LocationCode'];
      $_result['flightDetails']['departureDate']=date("Y-m-d",strtotime($_Asector_info[0]['Dep']['AircraftScheduledDateTime']));
      $_result['flightDetails']['departureTime']=date("H:m",strtotime($_Asector_info[0]['Dep']['AircraftScheduledDateTime']));
      $_result['flightDetails']['std']=$_Asector_info[0]['Dep']['AircraftScheduledDateTime'];
      $_result['flightDetails']['arrivalStation']=$_Asector_info[$lastKey]['Arrival']['IATA_LocationCode'];
      $_result['flightDetails']['arrivalDate']=date("Y-m-d",strtotime($_Asector_info[$lastKey]['Arrival']['AircraftScheduledDateTime']));
      $_result['flightDetails']['arrivalTime']=date("H:m",strtotime($_Asector_info[$lastKey]['Arrival']['AircraftScheduledDateTime']));
      $_result['flightDetails']['sta']=date("Y-m-d",strtotime($_Asector_info[$lastKey]['Arrival']['AircraftScheduledDateTime']));
      $_result['flightDetails']['stops']=1;
      $_result['flightDetails']['journeySellKey']=1;
      foreach ($_Asector_info as $_Asectorkey => $_AsectorValue) {
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['departureStation']=$_Asector_info[$_Asectorkey]['Dep']['IATA_LocationCode'];
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['arrivalStation']=$_Asector_info[$_Asectorkey]['Arrival']['IATA_LocationCode'];
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['std']=date("Y-m-d H:m:s",strtotime($_Asector_info[$_Asectorkey]['Dep']['AircraftScheduledDateTime']));
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['sta']=date("Y-m-d H:m:s",strtotime($_Asector_info[$_Asectorkey]['Arrival']['AircraftScheduledDateTime']));
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['state']='';
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['carrierCode']=$_Order['OwnerCode'];
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['flightNumber']=$_Asector_info[$_Asectorkey]['MarketingCarrierInfo']['MarketingCarrierFlightNumberText'];
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['departureTime']=date("H:m",strtotime($_Asector_info[$_Asectorkey]['Dep']['AircraftScheduledDateTime']));
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['arrivalDate']=date("Y-m-d",strtotime($_Asector_info[$_Asectorkey]['Arrival']['AircraftScheduledDateTime']));
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['arrivalTime']=date("H:m",strtotime($_Asector_info[$_Asectorkey]['Arrival']['AircraftScheduledDateTime']));
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['departureTerminal']='';
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['arrivalTerminal']='';
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['capacity']='';
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['sold']='';
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['segmentSellKey']='';
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['RecordNumber']='';
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['PhysicalFlightID']='';
        $_result['flightDetails']['viaFlights'][$_Asectorkey]['LogicalFlightID']='';
		
		
		
		if(!isset($_PaxList[0])){
			
			$_PaxList = array($_PaxList);
		}
        foreach ($_PaxList as $_Pax_Key => $_PaxValue) 
		{
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Key']=$_PaxValue['Individual']['IndividualID'];
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['PersonOrgID']=$_PaxValue['Individual']['IndividualID'];
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['FirstName']=$_PaxValue['Individual']['TitleName'];
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['LastName']=$_PaxValue['Individual']['GivenName'];
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['MiddleName']=$_PaxValue['Individual']['Surname'];
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Age']='';
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['DOB']=$_PaxValue['Individual']['Birthdate'];
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Gender']=$_Input[$_Pax_Key]['gender'];
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Title']=$_PaxValue['Individual']['TitleName'];
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['NationalityLaguageID']='';
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['RelationType']=$_Input[$_Pax_Key]['nationality'];
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['WBCID']='';
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['PTCID']='';
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['UseInventory']=false;
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['SeatAssignments']=array();
          $_result['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Charges']=array();
        }
       
      }
      
      foreach($_PaxList as $_PaxKey=>$_PaxValue){
		  
        $_result['paxDetails'][$_PaxKey]['paxType']		= $_PaxValue['PTC'];
        $_result['paxDetails'][$_PaxKey]['firstName']	= $_PaxValue['Individual']['GivenName'];
        $_result['paxDetails'][$_PaxKey]['lastName']	= $_PaxValue['Individual']['Surname'];
        $_result['paxDetails'][$_PaxKey]['title']		= $_PaxValue['Individual']['TitleName'];
        $_result['paxDetails'][$_PaxKey]['dob']			= $_PaxValue['Individual']['Birthdate'];
        $_result['paxDetails'][$_PaxKey]['gender']		= $_Input[$_PaxKey]['gender'];
        $_result['paxDetails'][$_PaxKey]['nationality']	= $_Input[$_PaxKey]['nationality'];
        $_result['paxDetails'][$_PaxKey]['personOrgId']	= $_PaxValue['PaxID'];
        $removeKeys = array('firstName', 'lastName','title','dob','gender','NationalityISO');
        foreach($removeKeys as $key) {
          unset($_Input[$_PaxKey]['passportDetails'][$key]);
        }
        $_result['paxDetails'][$_PaxKey]['passportDetails']=$_Input[$_PaxKey]['passportDetails'];
        foreach ($_AbaggageAllowanceList as $_Abagkey => $_Baggagevalue) {
			
			$_AssrDetailsArr = array();
          $_AssrDetailsArr['ssrCode']=$_Baggagevalue['BaggageAllowanceID'];
          $_AssrDetailsArr['ssrDescription']=$_Baggagevalue['WeightAllowance']['MaximumWeightMeasure']['content']." ".$_Baggagevalue['WeightAllowance']['MaximumWeightMeasure']['attributes']['UnitCode'];
          $_AssrDetailsArr['amount']='';
          $_AssrDetailsArr['defaultAmount']='';
          $_AssrDetailsArr['apiAmount']='';
          $_AssrDetailsArr['flightReferenceTemp']='';
          $_AssrDetailsArr['flightInfo']['departureStation']=$_Asector_info[0]['Dep']['IATA_LocationCode'];
          $_AssrDetailsArr['flightInfo']['arrivalStation']=$_Asector_info[$lastKey]['Arrival']['IATA_LocationCode'];
          ...
          foreach ($_PaxList as $_Pax_Key => $_PaxValue) {
            ...
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['Key']=$_PaxValue['Individual']['IndividualID'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['PersonOrgID']=$_PaxValue['Individual']['IndividualID'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['FirstName']=$_PaxValue['Individual']['TitleName'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['LastName']=$_PaxValue['Individual']['GivenName'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['MiddleName']=$_PaxValue['Individual']['Surname'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['Age']='';
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['DOB']=$_PaxValue['Individual']['Birthdate'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['Gender']=$_Input[$_Pax_Key]['gender'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['Title']=$_PaxValue['Individual']['TitleName'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['NationalityLaguageID']=$_Input[$_Pax_Key]['nationality'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['RelationType']=$_PaxValue['Individual']['Birthdate'];
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['WBCID']='';
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['PTCID']='';
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['UseInventory']=false;
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['SeatAssignments']=array();
            $paxDetailsArr[$_PaxKey]['ssrDetails']['pax_details']['Charges']=array();
          }
		  
		  $_AssrDetailsArr['paxDetails'] =  $paxDetailsArr;
		  
		  $_result['paxDetails'][$_PaxKey]['ssrDetails'][] = $_AssrDetailsArr;
		  
        }
		
        $_result['apiTotalBaseFare']=$_Order['TotalPrice']['BaseAmount']['content'];
        $_result['apiTotalTax']=$_Order['TotalPrice']['TaxSummary']['TotalTaxAmount']['content'];
        $_result['apiTotalBaggageFare']=0;
        $_result['apiTotalMealsFare']=0;
        $_result['apiTotalConnectFare']=0;
        $_result['apiTotalOtherCharges']=0;
        $_result['apiTotalFare']=0;
        $_result['defaultTotalBaseFare']=0;
        $_result['defaultTotalTax']=0;
        $_result['defaultTotalBaggageFare']=0;
        $_result['defaultTotalMealsFare']=0;
        $_result['defaultTotalConnectFare']=0;
        $_result['defaultTotalOtherCharges']=0;
        $_result['defaultTotalFare']=$_Order['TotalPrice']['TotalAmount']['content'];
        $_result['totalBaseFare']=$_Order['TotalPrice']['BaseAmount']['content'];
        $_result['totalTax']=$_Order['TotalPrice']['TaxSummary']['TotalTaxAmount']['content'];
        $_result['getBookingDetails']['pnr']=$_Order['OrderID'];
        $_result['getBookingDetails']['ReservationBalance']='';
        $_result['getBookingDetails']['lastTicketingDate']='';
        $_result['getBookingDetails']['status']='';
        $_result['getBookingDetails']['bookingStatus']=$_Order['OrderItem']['StatusCode'];
        $_result['getBookingDetails']['flightDetails']['departureStation']=$_Asector_info[0]['Dep']['IATA_LocationCode'];
        $_result['getBookingDetails']['flightDetails']['departureDate']=$_Asector_info[0]['Dep']['AircraftScheduledDateTime'];
        $_result['getBookingDetails']['flightDetails']['departureTime']=$_Asector_info[0]['Dep']['AircraftScheduledDateTime'];
        $_result['getBookingDetails']['flightDetails']['std']=$_Asector_info[0]['Dep']['AircraftScheduledDateTime'];
        $_result['getBookingDetails']['flightDetails']['arrivalStation']=$_Asector_info[$lastKey]['Arrival']['AircraftScheduledDateTime'];
        $_result['getBookingDetails']['flightDetails']['arrivalDate']=$_Asector_info[$lastKey]['Arrival']['AircraftScheduledDateTime'];
        $_result['getBookingDetails']['flightDetails']['arrivalTime']=$_Asector_info[$lastKey]['Arrival']['AircraftScheduledDateTime'];
        $_result['getBookingDetails']['flightDetails']['sta']=$_Asector_info[$lastKey]['Arrival']['AircraftScheduledDateTime'];
        $_result['getBookingDetails']['flightDetails']['stops']='';
        $_result['getBookingDetails']['flightDetails']['journeySellKey']='';
        foreach ($_Asector_info as $_Asectorkey => $_AsectorValue) {
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['departureStation']=$_AsectorValue['Dep']['IATA_LocationCode'];
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['arrivalStation']=$_AsectorValue['Arrival']['IATA_LocationCode'];
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['std']=$_AsectorValue['Dep']['AircraftScheduledDateTime'];
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['sta']=$_AsectorValue['Arrival']['AircraftScheduledDateTime'];
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['state']='';
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['carrierCode']=$_Order['OwnerCode'];
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['flightNumber']=$_AsectorValue['MarketingCarrierInfo']['MarketingCarrierFlightNumberText'];
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['departureTime']=$_AsectorValue['Dep']['AircraftScheduledDateTime'];
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['arrivalDate']=$_AsectorValue['Arrival']['AircraftScheduledDateTime'];
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['arrivalTime']=$_AsectorValue['Arrival']['AircraftScheduledDateTime'];
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['departureTerminal']='';
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['arrivalTerminal']='';
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['capacity']='';
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['sold']='';
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['segmentSellKey']='';
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['RecordNumber']='';
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['PhysicalFlightID']='';
          $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['LogicalFlightID']='';
          foreach ($_PaxList as $_Pax_Key => $_PaxValue) {
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Key']=$_PaxValue['Individual']['IndividualID'];
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['PersonOrgID']=$_PaxValue['Individual']['IndividualID'];
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['FirstName']=$_PaxValue['Individual']['TitleName'];
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['LastName']=$_PaxValue['Individual']['GivenName'];
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['MiddleName']=$_PaxValue['Individual']['Surname'];
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Age']='';
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['DOB']=$_PaxValue['Individual']['Birthdate'];
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Gender']=$_Input[$_Pax_Key]['gender'];
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Title']=$_PaxValue['Individual']['Birthdate'];
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['NationalityLaguageID']=$_Input[$_Pax_Key]['nationality'];
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['RelationType']='';
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['WBCID']='';
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['PTCID']='';
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['UseInventory']=false;
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['SeatAssignments']=array();
            $_result['getBookingDetails']['flightDetails']['viaFlights'][$_Asectorkey]['pax_details'][$_Pax_Key]['Charges']=array();
          }
