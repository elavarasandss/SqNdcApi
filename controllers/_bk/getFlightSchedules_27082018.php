...
class getFlightSchedules extends Execute
{
	...
	public function _modifyData()
	{
		...
		public function _getairlineData(){ // fro getting data from xml satish 27082018
		

			$_Sqlquery = 'select account_id from account_details where account_name = "'.$this->_Ainput['userName'].'"';
	...
	//	$_AairlinrData  = $this->_getairlineData();
		...
		/* getting airline code from xml satish 27082018 */
		$_AairlineArr = array();
