...
class getFlightSchedules extends Execute
{
    ...
    public function _doGetFlightSchedules()
	{
		...
		//echo "<pre>1";print_r($_AlowFareSearchResp);exit;
		
		
		foreach($this->_Ainput['sectorInfo'] as $_Akey => $_val){
			
			
			$origindestinationArr[$_Akey] = $_val['origin'].$_val['destination'];
      ...
      // Rubesh 30-04-2024
      $_AOriginDest_Keys = array_keys($_AoriginDestList);
			if ($_AOriginDest_Keys !== range(0, count($_AoriginDestList) - 1)) {
				
				$_AoriginDestListnew[]=$_AoriginDestList;
			}else{
				$_AoriginDestListnew=$_AoriginDestList;
			}
      $_ABaggageAllowance_Keys = array_keys($_AbaggageAllowanceList);
			if ($_AOriginDest_Keys !== range(0, count($_AbaggageAllowanceList) - 1)) {
				
				$_AbaggageAllowanceListNew[]=$_AbaggageAllowanceList;
			}else{
				$_AbaggageAllowanceListNew=$_AbaggageAllowanceList;
			}
     // Rubesh end 30-04-2024
		
			
			$_AflightResults = $_AoffersGroup;
			
			//echo "<pre>";print_r($_AflightResults);die;
			...
			foreach($_AflightResults as $_Akey => $_Aval){
				...
				if($_Aval['BaggageAllowance']['BaggageAllowanceRefID']){
					...
					foreach($_AbaggageAllowanceListNew as  $_AbagKey => $_AbagVal){
          ...
          // Rubesh 30-04-2024
					$_AOriginDest_Keys = array_keys($_Aval['JourneyOverview']['JourneyPriceClass']);
			    if ($_AOriginDest_Keys !== range(0, count($_Aval['JourneyOverview']['JourneyPriceClass']) - 1)) {
				    $JourneyPriceClass[]=$_Aval['JourneyOverview']['JourneyPriceClass'];
			    }else{
				    $JourneyPriceClass=$_Aval['JourneyOverview']['JourneyPriceClass'];
			    }
     ...
     // Rubesh end 30-04-2024
					// foreach($_Aval['JourneyOverview']['JourneyPriceClass'] as $_ApriceClassKey => $_ApriceClassValue){				//Onward //Return  
						...
						foreach ($JourneyPriceClass as $_ApriceClassKey => $_ApriceClassValue) {
						...
						foreach($_AoriginDestListnew as $_AoriginDestKey => $_AoriginDestVal){						
					
						//This contain, Onward and return sectors
						
						//print_r($_AoriginDestVal);//die;
						
						if(!is_array($_AoriginDestVal['PaxJourneyRefID'])){
							
							$_AoriginDestVal['PaxJourneyRefID'] = array($_AoriginDestVal['PaxJourneyRefID']);
						}
						
						//echo $_AflightJourneyId;
						
						//print_r($_AoriginDestVal['PaxJourneyRefID']);die;$_AoriginDestVal['OriginDestID']
							...
							if(in_array($_AflightJourneyId, $_AoriginDestVal['PaxJourneyRefID'])){
								...
								//echo "<pre>";print_r($_AoriginDestVal['OriginDestID']);//die;
								//echo "<pre>";print_r($origindestinationArr);die;
								//$origindestinationArr[$_Akey] = ;
								
								
								//echo $key;die;
								//echo "<pre>";print_r($_AoriginDestListnew);die;
								/* if(!empty($key)){
									
									$_AselectJourneyid = $key;		
								}else{
									$_AselectJourneyid = $_AoriginDestKey;		
								} */
								$key = array_search ($_AoriginDestVal['OriginDestID'], $origindestinationArr);			
								$_AselectJourneyid = $key;	
								...
								if(!isset($_ApaxJourneyList[0])){
									$_ApaxJourneyList = array($_ApaxJourneyList);
								}
							//echo "<pre>";print_r($_ApaxJourneyList);//die;
								foreach($_ApaxJourneyList as $_ApaxjourneyKey => $_ApaxjourneyVal ){
									//echo "<br>1___";echo $_ApaxjourneyVal['PaxJourneyID'];//die;
									//echo "2___";echo $_AflightJourneyId;//die;
										...
										foreach($segmentArr as $_AsegKey => $_AsegVal){
											...
											foreach($_ApaxSegmentList as $_AsementListKey => $_AsementListVal){
												...
												if($_AsementListVal['PaxSegmentID']==$_Asegmentid)
												{
													...
													$_AirlineCode 		= $_AsementListVal['OperatingCarrierInfo']['CarrierDesigCode'];
													$_AirlineName 		= $_AsementListVal['OperatingCarrierInfo']['CarrierName'];
													...
													$_Aviaflights['airlineName'] 		= $_AirlineCode;
													$_Aviaflights['airlineCode'] 		= $_AirlineName;
													...
													$_Aviaflights['baggageAllowance']['AllowanceType'] 	= $_Abaggagetype;
													 ...
													 // Rubesh 30-04-2024
                         /*  $_FareComponent_Keys = array_keys($_Aval['OfferItem']['FareDetail'][0]['FareComponent']);
                          if ($_FareComponent_Keys !== range(0, count($_Aval['OfferItem']['FareDetail'][0]['FareComponent']) - 1)) {
                            
                            $FareComponentClass[]=$_Aval['OfferItem']['FareDetail'][0]['FareComponent'];
                          }else{
                            $FareComponentClass=$_Aval['OfferItem']['FareDetail'][0]['FareComponent'];
                          } */
						  
						 
						  if(!isset($_Aval['OfferItem']['FareDetail'][0])){
							 $_Aval['OfferItem']['FareDetail'] = array($_Aval['OfferItem']['FareDetail']);
							  
						  } 
						  $FareComponentClass = $_Aval['OfferItem']['FareDetail'][0]['FareComponent'];
													//echo "<pre>";print_r($FareComponentClass);
													 // Rubesh end 30-04-2024
													foreach($FareComponentClass as $_AfareComKey =>  $_AfareComVal){
								...
								//echo "<pre>";print_r($_Aval['OfferItem']['FareDetail']);die;
								foreach($_Aval['OfferItem']['FareDetail'] as $_AfareDetailKey => $_AfareDetailValue)
								{
									...
									if(!isset($_ApaxList[0])){
										
										$_ApaxList = array($_ApaxList);
									}
								...
								$_Aresponse['OfferItem'] 	= $_Aval['OfferItem']['OfferItemID'];				
								$_Aresponse['ShoppingResponseID'] 	= $_AShoppingResponse['ShoppingResponseID'];				
      ...
      return $_Areturn = array
					(
						'status' => true,
						'data'   => $_AreturnArrDatas,
						'msg'    => "success",
					);
      // echo "<pre>";
			// print_r($_AreturnArrDatas);die;
          ...
          <PaxSegmentList>
            <PaxSegment>
              ...
              <Dep>
                ...
                <AircraftScheduledDateTime>2024-06-25T01:10:00</AircraftScheduledDateTime>
              </Dep>
              <Arrival>
                <IATA_LocationCode>SIN</IATA_LocationCode>
                <TerminalName>0</TerminalName>
                <AircraftScheduledDateTime>2024-06-25T08:40:00</AircraftScheduledDateTime>
              </Arrival>
            ...
            <PaxSegment>
              ...
              <Dep>
                ...
                <AircraftScheduledDateTime>2024-06-25T18:30:00</AircraftScheduledDateTime>
              </Dep>
              <Arrival>
                <IATA_LocationCode>HYD</IATA_LocationCode>
                <AircraftScheduledDateTime>2024-06-25T19:40:00</AircraftScheduledDateTime>
              </Arrival>
              <MarketingCarrierInfo>
            ...
            <PaxSegment>
              ...
              <Dep>
                <IATA_LocationCode>MAA</IATA_LocationCode>
                <TerminalName>4</TerminalName>
                <AircraftScheduledDateTime>2024-06-25T10:00:00</AircraftScheduledDateTime>
              </Dep>
              <Arrival>
                <IATA_LocationCode>SIN</IATA_LocationCode>
                <TerminalName>0</TerminalName>
                <AircraftScheduledDateTime>2024-06-25T16:45:00</AircraftScheduledDateTime>
              </Arrival>
              <MarketingCarrierInfo>
                <CarrierDesigCode>SQ</CarrierDesigCode>
            ...
            <PaxSegment>
              ...
              <Dep>
                <IATA_LocationCode>MAA</IATA_LocationCode>
                <TerminalName>4</TerminalName>
                <AircraftScheduledDateTime>2024-06-25T20:55:00</AircraftScheduledDateTime>
              </Dep>
              <Arrival>
                <IATA_LocationCode>CMB</IATA_LocationCode>
                <AircraftScheduledDateTime>2024-06-25T22:15:00</AircraftScheduledDateTime>
              </Arrival>
              <MarketingCarrierInfo>
                <CarrierDesigCode>UL</CarrierDesigCode>
            ...
            <PaxSegment>
              ...
              <Dep>
                <IATA_LocationCode>MAA</IATA_LocationCode>
                <TerminalName>4</TerminalName>
                <AircraftScheduledDateTime>2024-06-25T23:15:00</AircraftScheduledDateTime>
              </Dep>
              <Arrival>
                <IATA_LocationCode>SIN</IATA_LocationCode>
                <TerminalName>0</TerminalName>
                <AircraftScheduledDateTime>2024-06-26T05:55:00</AircraftScheduledDateTime>
              </Arrival>
              <MarketingCarrierInfo>
                <CarrierDesigCode>SQ</CarrierDesigCode>
            ...
            <PaxSegment>
              ...
              <DatedOperatingLeg>
                ...
                <Arrival>
                  <IATA_LocationCode>BLR</IATA_LocationCode>
                  <TerminalName>1</TerminalName>
                  <AircraftScheduledDateTime>2024-06-31T11:05:00</AircraftScheduledDateTime>
                </Arrival>
                <IATA_AircraftType>
                  <IATA_AircraftTypeCode>7M8</IATA_AircraftTypeCode>
                </IATA_AircraftType>
            ...
            <PaxSegment>
              ...
              <Dep>
                <IATA_LocationCode>HYD</IATA_LocationCode>
                <AircraftScheduledDateTime>2024-06-25T23:10:00</AircraftScheduledDateTime>
              </Dep>
              <Arrival>
                <IATA_LocationCode>SIN</IATA_LocationCode>
                <TerminalName>0</TerminalName>
                <AircraftScheduledDateTime>2024-06-26T06:05:00</AircraftScheduledDateTime>
              </Arrival>
              <MarketingCarrierInfo>
                <CarrierDesigCode>SQ</CarrierDesigCode>
