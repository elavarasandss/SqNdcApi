...
class getServiceList extends Execute
{
    ...
    public function _dogetServiceList()
	{
		$_Bstatus  = true;
		$_Smessage = '';
		$_Adata	   = array();
    ...
    // echo "<pre>";print_r($_AflightResult);die;
		 ...
		 return $_AlowFareSearchResp = $this->xmlstrToArray($_AflightResult);
     
		$_AflightResult = $_AlowFareSearchResp['Body']['ServiceListRS'];
