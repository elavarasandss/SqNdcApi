...
class getSeatAvailability extends Execute
{
    ...
    public function _doGetSeatAvailability()
	{
		$_Bstatus  = true;
		$_Smessage = '';
		$_Adata	   = array();
		...
		$_AflightResult = $_AlowFareSearchResp['Body']['SeatAvailabilityRS'];
    ...
    echo "<pre>";print_r($_AflightResult);die;
		...
		if(isset($_AflightResult['Response']) && $_AflightResult['Response'] && count($_AflightResult['Response']) > 0){
			...
			$_ASeatMap 			 = $_AflightResult['Response']['SeatMap'];
      // echo "<pre>";print_r($_AflightResult);die;
			
			$_ApaxJourneyList	 	 = $_AflightResult['Response']['DataLists']['PaxJourneyList']['PaxJourney'];
			$_ApaxList	 	 		 = $_AflightResult['Response']['DataLists']['PaxList'];
			$_ApaxSegmentList	 	 = $_AflightResult['Response']['DataLists']['PaxSegmentList']['PaxSegment'];
			$_AServiceDefinitionList	 	 = $_AflightResult['Response']['DataLists']['ServiceDefinitionList']['ServiceDefinition'];
			// $_AShoppingResponse	 	 = $_AflightResult['Response']['ShoppingResponse'];
      foreach ($_ASeatMap['CabinCompartment']['CabinComponent'] as $_Seatkey => $_Seatvalue) {
        $_SeatDetails[$_Seatkey]['Characteristic']=array();
        $_SeatDetails[$_Seatkey]['Remark']='';
        $_SeatDetails[$_Seatkey]['attributes']['Type']='';
        $_SeatDetails[$_Seatkey]['attributes']['SeatCode']=$_Seatvalue['FirstRowNumber'].$_Seatvalue['ColumnID'];
        $_SeatDetails[$_Seatkey]['attributes']['Availability']='';
        $_SeatDetails[$_Seatkey]['attributes']['Paid']='';
        $_SeatDetails[$_Seatkey]['attributes']['OptionalServiceRef']='';
      }
			foreach ($_ApaxList as $_Paxkey => $_Paxvalue) {
       $_AfinalResult[$_Paxkey]['key']='';
       $_AfinalResult[$_Paxkey]['Value'][$_Paxvalue['PaxID']]['Facility']=$_SeatDetails;
      }
			
			
      echo "<pre>";print_r($_AfinalResult);die;
